...
b.options.true_pos;a=!0});d(document).mousemove(function(c){a&&(0!=c.buttons%2?(b.options.true_pos=b.options_pos_init+(c.clientX-b.drag_start_pos_x),b.options.true_pos<b.options.true_pos_min?b.options.true_pos=b.options.true_pos_min:b.options.true_pos>b.options.true_pos_max&&(b.options.true_pos=b.options.true_pos_max)):a=!1,b.$.pixie("emit","resize"))})},r={initialized:!1,show:function(){var a=g(this.$);this.initialized||(n.call(this),k.call(this),f(this.children),e(this.options,a.width),this.children[0].$.appendTo(this.$),
...
function(){var a=this.$.width();this.bar.$.css({cursor:"row-resize",width:a,height:this.options.border});for(var b=0;b<this.children.length;b++)this.children[b].$.css({width:a})},t=function(){p.call(this);var a=!1,b=this;this.bar.$.mousedown(function(c){b.drag_start_pos_y=c.clientY;b.options_pos_init=b.options.true_pos;a=!0});d(document).mousemove(function(c){a&&(0!=c.buttons%2?(b.options.true_pos=b.options_pos_init+(c.clientY-b.drag_start_pos_y),b.options.true_pos<b.options.true_pos_min?b.options.true_pos=
