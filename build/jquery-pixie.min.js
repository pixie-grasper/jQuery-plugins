...
center:{x:void 0,y:void 0},left:void 0,top:void 0,right:void 0,bottom:void 0}},k=function(){for(var b=[],a="vss vskip vkern hss hskip hkern box".split(" "),d=0;d<a.length;d++)this[a[d]]=function(f){return function(d){for(var h=[],c=0;c<arguments.length;++c)h[c-0]=arguments[c];b.push({command:a[f],args:h});return this}}(d);var h,c;this.load=function(){h=[];c=[];for(var a=[],d=0;d<b.length;d++)switch(b[d].command){case "vss":case "vskip":case "vkern":0!=a.length&&(h.push([0,a]),a=[]);h.push([1,b[d]]);
break;case "hss":case "hskip":case "hkern":a.push(b[d]);break;case "box":a.push(b[d]),c.push(b[d])}0!=a.length&&h.push([0,a]);return this};this.show=function(a,b,d){if(!a._.firstChild){c||this.load();for(var f=0;f<c.length;f++)a.append(c[f].args[0])}for(var q=0,e=f=a=0;e<h.length;e++){var g=h[e];if(0==g[0]){for(var l=g[1],k=0,r=0,m=0,n=0,p=0;p<l.length;p++){var t=l[p];switch(t.command){case "hss":m++;break;case "hskip":n++;k+=t.args[0];break;case "hkern":k+=t.args[0];break;case "box":k+=t.args[0].prop("scrollWidth"),
r=Math.max(r,t.args[0].prop("scrollHeight"))}}0!=m&&(n=0);g[2]={badness:b-k,height:r,count_hss:m,count_hskip:n};q+=r}else switch(g[1].command){case "vss":a++;break;case "vskip":f++;q+=g[1].args[0];break;case "vkern":q+=g[1].args[0]}}0!=a&&(f=0);b=d-q;for(q=d=0;q<h.length;q++)if(l=h[q],0==l[0])for(e=0,g=l[1],l=l[2],k=0;k<g.length;k++)switch(r=g[k],r.command){case "hss":0!=l.count_hss&&(e+=l.badness/l.count_hss);break;case "hskip":0!=l.count_hskip&&(e+=l.badness/l.count_hskip);e+=r.args[0];break;case "hkern":e+=
r.args[0];break;case "box":r.args[0].attr({x:e,y:d+l.height}),e+=r.args[0].prop("scrollWidth")}else switch(l[1].command){case "vss":0!=a&&(d+=b/a);break;case "vskip":0!=f&&(d+=b/f);d+=l[1].args[0];break;case "vkern":d+=l[1].args[0]}return this}},n=function(b){return{width:b.width(),height:b.height()}},m=function(b){this._=document.createElementNS("http://www.w3.org/2000/svg",b);this.attr=function(a){var b=this._;Object.keys(a).forEach(function(d){b.setAttribute(d,a[d])});return this};this.css=function(a){var b=
this._;Object.keys(a).forEach(function(d){b.style[d]=a[d]});return this};this.appendTo=function(a){a instanceof jQuery?a[0].appendChild(this._):a instanceof m&&a._.appendChild(this._);return this};this.append=function(a){a instanceof jQuery?this._.appendChild(a[0]):a instanceof m?this._.appendChild(a._):this._.appendChild(a);return this};this.empty=function(){for(var a=this._;a.firstChild;)a.removeChild(a.firstChild);return this}},p=function(b){for(var a=[],d=0;d<arguments.length;++d)a[d-0]=arguments[d];
for(var c=d=0;c<a.length;c++)"undefined"!==typeof a[c]&&d++;return d},u=function(){var c=n(this.$),a=this.options.initial,d=p(a.scale,a.left,a.right,a.center.x),h=p(a.scale,a.top,a.bottom,a.center.y);if(2<d||2<h)b.error("too many initial parameter detected.");else if(2==d&&2==h)if(a.scale)this.scale=a.scale,this.x=a.left?a.left:a.center.x?a.center.x-c.width*a.scale/2:a.right-c.width*a.scale,this.y=a.top?a.top-c.height*a.scale:a.center.y?a.center.y-c.height*a.scale/2:a.bottom;else{var e,f;a.left&&
a.right?(d=a.left,e=a.right):a.left&&a.center.x?(d=a.left,e=2*a.center.x-a.left):(d=2*a.center.x-a.right,e=a.right);f=c.width/(e-d);a.top&&a.bottom?(h=a.top,a=a.bottom):a.top&&a.center.y?(h=a.top,a=2*a.center-a.top):(h=2*a.center-a.bottom,a=a.bottom);this.scale=Math.min(f,c.height/(h-a));f=1/this.scale;this.x=(d+e)/2-c.width*f/2;this.y=(h+a)/2-c.height*f/2}else 1==d&&2==h&&"undefined"===typeof a.scale?(a.top&&a.bottom?(d=a.top,h=a.bottom):a.top&&a.center.y?(d=a.top,h=2*a.center-a.top):(d=2*a.center-
a.bottom,h=a.bottom),this.scale=c.height/(d-h),this.x=a.left?a.left:a.center.x?a.center.x-c.width*this.scale/2:a.right-c.width*this.scale):2==d&&1==h&&"undefined"===typeof a.scale?(a.left&&a.right?(d=a.left,h=a.right):a.left&&a.center.x?(d=a.left,h=2*a.center.x-a.left):(d=2*a.center.x-a.right,h=a.right),this.scale=c.width/(h-d),this.y=a.top?a.top-c.height*this.scale:a.center.y?a.center.y-c.height*this.scale/2:a.bottom):0==d&&0==h?(this.y=this.x=0,this.scale=1):b.error("too few initial parameter detected.")},
w=function(){u.call(this);var c=n(this.$);this.svg={_:(new m("svg")).attr({viewBox:"0 0 "+c.width+" "+c.height,xmlns:"http://www.w3.org/2000/svg"}).css({position:"absolute",width:c.width,height:c.height})};this.svg.$=b(this.svg._._).appendTo(this.$);this.overlap_elements=new k;this.options.overlap_elements(this.overlap_elements);this.overlap_elements.load();var a=this,d=!1,e=null,g=null,f=null,p=null;this.svg.$.mousedown(function(c){var h=n(a.$),l=1/a.scale;e=c.clientX;g=c.clientY;f=a.x+h.width*l;
p=a.y+h.height*l;c=b("body")[0].style;c.cursor="grabbing";""==c.cursor&&(c.cursor="-moz-grabbing",""==c.cursor&&(c.cursor="-webkit-grabbing"));d=!0}).on("onwheel"in document?"wheel":"onmousewheel"in document?"mousewheel":"DOMMouseScroll",function(b){var d=n(a.$),c=1/a.scale,f=a.scale_base,e=1/f,h=a.x+b.clientX*c,d=a.y+(d.height-b.clientY)*c;b=b.originalEvent.deltaY?-b.originalEvent.deltaY:b.originalEvent.wheelDelta?b.originalEvent.wheelDelta:b.originalEvent.detail;0>b?a.zoom(h,d,f):a.zoom(h,d,e);
a.show();a.update_overlaps(h,d)});b(document).mousemove(function(b){var c=1/a.scale;d&&a.moveto(f-(b.clientX-e)*c,p+(b.clientY-g)*c);var h=n(a.$);a.update_overlaps(a.x+b.clientX*c,a.y+(h.height-b.clientY)*c)}).mouseup(function(a){b("body").css({cursor:""});d=!1})},v={is_pixie:!0,type_of:"atlas",kind_of:{atlas:!0},initialize:function(e){var a=g.container.apply(this);b.extend(!0,a,v);a.options=b.extend(!0,{},c,e);b(window).resize(function(){a.resize();return!0});return a},show:function(){this.initialized||
(w.call(this),this.initialized=!0);var c=n(this.$),a=this.scale,d=1/a,d=[this.x,this.y,this.x+c.width*d,this.y+c.height*d],e=!1;if(null==this.cached_box_size)this.cached_box_size=d,e=!0;else if(d[0]<this.cached_box_size[0]||d[1]<this.cached_box_size[1]||d[2]>this.cached_box_size[2]||d[3]>this.cached_box_size[3]){for(var e=[Math.min,Math.min,Math.max,Math.max],g=0;4>g;g++)this.cached_box_size[g]=e[g](d[g],this.cached_box_size[g]);e=!0}if(e){this.cache_id_list=this.options.listup.call.apply(this.options.listup,
[].concat([this],$jscomp.arrayFromIterable(this.cached_box_size)));this.g={_:new m("g")};this.g.$=b(this.g._._);this.g._.appendTo(this.svg._.empty());this.cache_SVG_list=[];e=this.cache_id_list;for(g=0;g<e.length;g++){var f=this.options.fetch.call(this,e[g]);switch(f.type){case "circle":f={_:(new m("circle")).attr({stroke:f.stroke||"",fill:f.fill||""}),type:"circle",cx:f.cx,cy:f.cy,r:f.r};this.cache_SVG_list[g]=f;f._.appendTo(this.g.$);break;default:b.error("unknown type "+f.type+" detected.")}}this.g2=
{_:new m("g")};this.g2._.appendTo(this.svg._);this.overlap_elements.show(this.g2._,c.width,c.height)}e=this.cache_SVG_list;for(g=0;g<e.length;g++)switch(e[g].type){case "circle":e[g]._.attr({cx:(e[g].cx-d[0])*a,cy:c.height-(e[g].cy-d[1])*a,r:e[g].r*a})}return this},drop_cache:function(){this.cache_SVG_list=this.cache_id_list=this.cached_box_size=null;return this},resize:function(){var b=n(this.$);this.svg._.attr({viewBox:"0 0 "+b.width+" "+b.height}).css({width:b.width,height:b.height});this.show.call(this);
return this},zoom:function(b,a,c){this.scale/=c;this.x=b-(b-this.x)*c;this.y=a-(a-this.y)*c;return this},moveto:function(b,a){var c=n(this.$),e=1/this.scale;this.x=b-c.width*e;this.y=a-c.height*e;this.show();return this},update_overlaps:function(b,a){var c=n(this.$);this.options.update_overlaps(b,a,this.scale);this.overlap_elements.show(this.g2._,c.width,c.height);return this},initialized:!1,cached_box_size:null,scale_base:1.3};return function(b){for(var a=[],c=0;c<arguments.length;++c)a[c-0]=arguments[c];
return v.initialize.apply(this,a)}}()};b.fn.pixie=function(c,k){for(var e=[],m=1;m<arguments.length;++m)e[m-1]=arguments[m];if(g[c])return g[c].apply(this,e);b.error("Widget named "+c+" not found.")};b(".pixie-widget").hide()})(jQuery);
